...
namespace MultiPlug.Ext.Network.HTTP.Controllers
{
    internal class Templates
    {
        internal const string SettingsHome = "Network_HTTP_Settings_Home";
        internal const string SettingsAbout = "Network_HTTP_Settings_About";
        internal const string SettingsHttpClient = "Network_HTTP_Settings_HttpClient";
        internal const string SettingsHttpClientNavigation = "Network_HTTP_Settings_Navigation";
