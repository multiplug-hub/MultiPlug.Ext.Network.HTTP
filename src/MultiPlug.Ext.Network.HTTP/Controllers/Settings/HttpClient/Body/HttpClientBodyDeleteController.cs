...
namespace MultiPlug.Ext.Network.HTTP.Controllers.Settings.HttpClient.Body
{
    [Route("httpclient/body/delete")]
    public class HttpClientBodyDeleteController : SettingsApp
    {
        public Response Post(string id, string key)
        {
            ...
            if (HttpClientSearch.DeleteBodyParam(key))
            {
                return new Response
                {
